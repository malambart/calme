...
<form class="form-horizontal" role="form" method="POST" action="{{ url('/parents/'.$parent->id.'/edit') }}">
	...
	<div class="form-group{{ $errors->has('prenom') ? ' has-error' : '' }}">
		...
		<div class="col-md-6">
			<input id="prenom" type="text" class="form-control" name="prenom" value="{{ old('prenom', $parent->prenom) }}" autofocus>
	...
	<div class="form-group{{ $errors->has('nom') ? ' has-error' : '' }}">
		...
		<div class="col-md-6">
	  		<input id="nom" type="text" class="form-control" name="nom" value="{{ old('nom', $parent->nom) }}" autofocus>
	  		@if ($errors->has('nom'))
	  		<span class="help-block">
	...
	<div class="form-group{{ $errors->has('courriel') ? ' has-error' : '' }}">
		...
		<div class="col-md-6">
			<input id="courriel" type="text" class="form-control" name="courriel" value="{{ old('courriel', $parent->courriel) }}" autofocus>
	...
	<div class="form-group{{ $errors->has('tel') ? ' has-error' : '' }}">
		...
		<div class="col-md-6">
			<input id="tel" type="text" class="form-control" name="tel" value="{{ old('tel', $parent->tel) }}" autofocus>
			@if ($errors->has('tel'))
			<span class="help-block">
	...
	<div class="form-group{{ $errors->has('tel2') ? ' has-error' : '' }}">
		...
		<div class="col-md-6">
			<input id="tel2" type="text" class="form-control" name="tel2" value="{{ old('tel2', $parent->tel2) }}" autofocus>
			@if ($errors->has('tel2'))
			<span class="help-block">
