...
@section('body')
    <form class="form-horizontal" role="form" method="POST" action="{{ url('/parents/'.$id.'/create') }}">
        ...
        <div hidden id="input_lien_autre" class="form-group{{ $errors->has('lien_autre') ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                <input id="lien_autre" type="text" class="form-control" name="lien_autre"
                       value="{{ old('lien_autre') }}" autofocus>
        ...
        <div class="form-group{{ $errors->has('tel') ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                    <input id="tel" type="text" class="form-control tel-mask" name="tel" value="{{ old('tel') }}"
                           autofocus>
                    <input id="ext" type="text" class="form-control tel-ext" name="ext" value="{{ old('ext') }}" autofocus placeholder="ext. / commentaires">
                @if ($errors->has('tel'))
                    <span class="help-block">
        ...
        <div class="form-group{{ $errors->has('tel2') ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                <input id="tel2" type="text" class="form-control tel-mask" name="tel2" value="{{ old('tel2') }}"
                       autofocus>
                <input id="ext" type="text" class="form-control tel-ext" name="ext2" value="{{ old('ext2') }}" autofocus placeholder="ext. / commentaires">
                @if ($errors->has('tel2'))
                    <span class="help-block">
